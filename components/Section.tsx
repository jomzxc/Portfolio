  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto w-full relative">
        ...
        <h2 className="text-2xl md:text-3xl font-mono font-bold text-primary mb-12 flex items-center text-glow">
      ...
      <div className="section-separator w-full max-w-2xl mx-auto pt-24" aria-hidden="true">
