...
const TimelineItem: React.FC<TimelineItemProps> = ({ event, index }) => {
  ...
  return (
    ...
    >
      ...
      <div className="group relative bg-bg-card backdrop-blur-md border border-primary/20 rounded-lg p-6 overflow-hidden transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/20">
